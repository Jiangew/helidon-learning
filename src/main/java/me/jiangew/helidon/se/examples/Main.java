...
package me.jiangew.helidon.se.examples;
...
public final class Main {
    ...
    private static Routing createRouting() {
        return Routing.builder().register(JsonSupport.get()).register("/greet", new GreetService()).build();
    }
    ...
    protected static WebServer startServer() throws IOException {
        ...
        ServerConfiguration serverConfig = ServerConfiguration.builder()
                                                              ...
                                                              .tracer(ZipkinTracerBuilder.forService("greeting").zipkin("http://localhost:9411").build())
                                                              .build();
